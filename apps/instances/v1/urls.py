...
from apps.instances.v1 import views
...
urlpatterns = [
    ...
    path(INSTANCE_PREFIX, include('apps.codeboxes.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.invitations.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.apikeys.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.triggers.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.webhooks.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.users.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.channels.v1.urls')),
    path(INSTANCE_PREFIX, include('apps.high_level.v1.urls')),
