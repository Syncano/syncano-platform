...
DOCKER_NETWORK = os.environ.get('DOCKER_NETWORK', 'isolated_nw')
DOCKER_NETWORK_SUBNET = os.environ.get('DOCKER_NETWORK_SUBNET', '172.25.0.0/16')
...
DOCKER_DNS = os.environ.get('DOCKER_DNS', '8.8.8.8, 8.8.4.4').split(',')
...
DATA_OBJECT_STATEMENT_TIMEOUT = 2000  # milliseconds
...
SOCKETS_MAX_PAYLOAD = 15 * 1024 * 1024  # 15MB
