...
LOADERIO_TOKEN = os.environ.get('LOADERIO_TOKEN', "loaderio-8332184479a8ce8d138988282781025f")
...
SOCKETS_MAX_ZIP_FILE_SIZE = 15 * 1024 * 1024  # 25MB
SOCKETS_MAX_ENVIRONMENT_SIZE = 35 * 1024 * 1024  # 25MB
